const translations = {
  en: {
    ...
    // Home
    home: {
      rotatingWords: ['beautifully.', 'confidently.', 'gracefully.'],
      welcomeTitle: 'Welcome to LIV Wellness & Aesthetics',
      welcomeSubtitle: 'Beauty rooted in wellness. Wellness elevated by science',
      welcomeBody:
        'LIV Wellness & Aesthetics is a haven of calm where science-led care meets timeless luxury. Whether you are replenishing your skin, restoring balance, or elevating your glow, every visit is designed to feel soothing, personal, and transformative.',
    ...
    services: {
      ...
      pageSubtitle:
        'Personalized aesthetic and wellness treatments designed to help you look refreshed, feel revitalized, and reach your goals with confidence.',
      bookYour: 'Book your',
      appointment: 'appointment',
      items: [
        {
    ...
    // About Us
    aboutUs: {
      pageTitle: 'About LIV Wellness & Aesthetics',
      pageSubtitle:
        'A soft, luxurious space where science-led wellness meets timeless beauty. Every touchpoint is crafted to help you feel calm, confident, and authentically you.',
      sections: [
        {
    ...
    contact: {
      ...
      pageSubtitle:
        'Visit our studio or reach out to plan your next appointment. We love creating calm, elevated experiences tailored to you.',
      visitUs: 'Visit Us',
      hours: 'Hours',
      hoursValue: [
        ...
        { day: 'Saturday', hours: '10:00 AM – 7:30 PM', bold: true },
      ],
      callOrEmail: 'Call or Email',
      phone: 'Phone',
      email: 'Email',
    },
    ...
    footer: {
      ...
      address: 'Address',
      email: 'Email',
      hours: 'Hours: Mon–Sat 10:00 AM – 7:30 PM | Sun: Closed',
      privacyNotice: 'Privacy Notice',
      copyright: 'LIV Wellness & Aesthetics. All rights reserved.',
    },
  ...
  es: {
    ...
    // Home
    home: {
      rotatingWords: ['bellamente.', 'con confianza.', 'con gracia.'],
      welcomeTitle: 'Bienvenidos a LIV Wellness & Aesthetics',
      welcomeSubtitle: 'Belleza arraigada en el bienestar. Bienestar elevado por la ciencia',
      welcomeBody:
        'LIV Wellness & Aesthetics es un refugio de calma donde el cuidado guiado por la ciencia se encuentra con el lujo atemporal. Ya sea que estés reponiendo tu piel, restaurando el equilibrio o elevando tu brillo, cada visita está diseñada para sentirse reconfortante, personal y transformadora.',
      bookOnline: 'Reservar en línea',
      servicesHeading: 'SERVICIOS',
      aboutUsHeading: 'SOBRE NOSOTROS',
      aboutUsBody:
        'LIV Wellness & Aesthetics es un estudio de bienestar y estética de lujo dedicado a ofrecer resultados naturales y refinados a través de tratamientos médicos avanzados, terapias enfocadas en la longevidad y cuidado personalizado. Nuestra estética suave y nude refleja nuestra filosofía: la belleza debe sentirse sin esfuerzo, equilibrada y atemporal. En LIV, elevamos tu bienestar, mejoramos tu belleza y te empoderamos para vivir con confianza, por dentro y por fuera.',
      viewMore: 'Ver más',
      viewAllServices: 'Ver todos los servicios',
      bookYour: 'Reservar tu cita de',
      appointment: '',
      featuredServices: [
        {
    ...
    services: {
      ...
      pageSubtitle:
        'Tratamientos estéticos y de bienestar personalizados diseñados para ayudarte a lucir renovado/a, sentirte revitalizado/a y alcanzar tus metas con confianza.',
      bookYour: 'Reservar tu cita de',
      appointment: '',
      items: [
        {
    ...
    // About Us
    aboutUs: {
      pageTitle: 'Sobre LIV Wellness & Aesthetics',
      pageSubtitle:
        'Un espacio suave y lujoso donde el bienestar guiado por la ciencia se encuentra con la belleza atemporal. Cada detalle está diseñado para ayudarte a sentirte en calma, con confianza y auténticamente tú.',
      sections: [
        {
          title: 'Marca insignia',
          body: [
            'LIV Wellness & Aesthetics es un estudio de bienestar y estética de lujo dedicado a ofrecer resultados naturales y refinados a través de tratamientos médicos avanzados, terapias enfocadas en la longevidad y cuidado personalizado. Nuestra estética suave y nude refleja nuestra filosofía: la belleza debe sentirse sin esfuerzo, equilibrada y atemporal. En LIV, elevamos tu bienestar, mejoramos tu belleza y te empoderamos para vivir con confianza, por dentro y por fuera.',
          ],
        },
        {
          ...
          body: [
            'En LIV Wellness & Aesthetics, cada detalle está diseñado para reflejar calma, suavidad y lujo. Desde nuestra paleta de tonos nude hasta nuestros planes de tratamiento cuidadosamente seleccionados, creamos un entorno transformador que honra tu individualidad y realza tu belleza natural.',
            'Nuestros tratamientos rejuvenecen a todos los niveles: piel, cuerpo y salud celular, para que puedas envejecer con gracia, vitalidad y belleza. Creemos que la belleza es un estilo de vida y el bienestar es la base.',
          ],
        },
        {
          title: 'Nuestra historia',
          body: [
            'LIV Wellness & Aesthetics fue creado con un propósito: elevar la forma en que las personas experimentan el autocuidado. Basado en la filosofía de que el bienestar y la belleza son inseparables, LIV ofrece un espacio donde los clientes pueden restaurarse, rejuvenecerse y redescubrirse a través de un cuidado avanzado basado en evidencia.',
            'Cada detalle, desde la paleta de colores hasta la selección de tratamientos, fue diseñado para reflejar serenidad, sofisticación y transformación duradera. Aquí, el envejecimiento no se teme. Se abraza. Y se mejora.',
          ],
        },
        {
          title: 'Quiénes somos',
          body: [
            'LIV Wellness & Aesthetics es un estudio de bienestar de lujo especializado en rejuvenecimiento facial avanzado, optimización corporal y servicios de longevidad. Creemos que la verdadera belleza comienza con el equilibrio: en tu piel, tu cuerpo y tu estilo de vida.',
            'Con tratamientos de última generación, incluyendo TriLift (TM), Morpheus8, sueros de bienestar IV, optimización hormonal y programas metabólicos, creamos recorridos individualizados que aportan armonía a tu salud y elegancia a tu apariencia.',
          ],
        },
        {
          title: 'Visión',
          body: [
            'Nuestra visión es redefinir el estándar de belleza y bienestar creando un espacio donde la ciencia y la elegancia se fusionen sin esfuerzo. Aspiramos a empoderar a cada cliente para que abrace el envejecimiento con confianza, vitalidad y gracia, guiado por tratamientos que realzan la belleza natural y extienden el bienestar general.',
          ],
        },
        {
          title: 'Misión',
          body: [
            'En LIV Wellness & Aesthetics, nuestra misión es elevar la forma en que experimentas la belleza y el bienestar. Combinamos estética médica avanzada con medicina de longevidad moderna para ayudarte a lucir, sentirte y vivir lo mejor posible. Nuestro enfoque son los resultados atemporales, el cuidado personalizado y un entorno de lujo diseñado para nutrir la confianza desde adentro hacia afuera.',
          ],
        },
      ],
    },
    ...
    contact: {
      ...
      pageSubtitle:
        'Visite nuestro estudio o comuníquese para planificar su próxima cita. Nos encanta crear experiencias tranquilas y elevadas adaptadas a usted.',
      visitUs: 'Visítenos',
      hours: 'Horario',
      hoursValue: [
        ...
        { day: 'Sábado', hours: '10:00 AM – 7:30 PM', bold: true },
      ],
    ...
    footer: {
      ...
      address: 'Dirección',
      email: 'Correo',
      hours: 'Horario: Lun–Sáb 10:00 AM – 7:30 PM | Dom: Cerrado',
      privacyNotice: 'Aviso de Privacidad',
      copyright: 'LIV Wellness & Aesthetics. Todos los derechos reservados.',
    },
