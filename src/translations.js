const translations = {
  en: {
    ...
    contact: {
      ...
      visitUs: 'Visit Us',
      hours: 'Hours',
      hoursValue: ['Mon–Fri: 9am–6pm', 'Sat: 10am–2pm'],
    ...
    footer: {
      ...
      address: 'Address',
      email: 'Email',
      hours: 'Hours: Mon–Fri 9am–6pm, Sat 10am–2pm',
  ...
  es: {
    ...
    contact: {
      ...
      visitUs: 'Visítenos',
      hours: 'Horario',
      hoursValue: ['Lun–Vie: 9am–6pm', 'Sáb: 10am–2pm'],
    ...
    footer: {
      ...
      address: 'Dirección',
      email: 'Correo',
      hours: 'Horario: Lun–Vie 9am–6pm, Sáb 10am–2pm',
